                                        ...
                                        <div class="col-sm-12">
                                            <div class="jumbotron jumbotron-fluid py-3">
                                                <div class="container">
                                                    ...
                                                    <div class="col-12">
                                                    <!-- Recomendaciones, obtenidas de las reglas -->
                                                    <!-- Si no hay recomendaciones, poner <p>There are no recommendations from this clinical practice guideline for this patient.</p> -->
